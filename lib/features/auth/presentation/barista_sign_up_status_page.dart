...
/// Pantalla reservada para el flujo de registro de barista con el backend.
class BaristaSignUpStatusPage extends StatelessWidget {
  const BaristaSignUpStatusPage({super.key});
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Tu cuenta de barista ha sido creada exitosamente.',
                            textAlign: TextAlign.center,
